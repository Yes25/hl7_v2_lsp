...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_message_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  ...
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msh, 5, 0, 0),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_segment, 2, 0, 0),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_segment_separator, 1, 0, 0),
